export class l2_social_interests_view extends HTMLElement {
    constructor() {
        super();
...
customElements.define("l2-social-interests-view", l2_social_interests_view)