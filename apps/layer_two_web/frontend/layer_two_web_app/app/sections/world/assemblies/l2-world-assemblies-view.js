export class l2_world_assemblies_view extends HTMLElement {
    constructor() {
        super();
...
customElements.define("l2-world-assemblies-view", l2_world_assemblies_view)