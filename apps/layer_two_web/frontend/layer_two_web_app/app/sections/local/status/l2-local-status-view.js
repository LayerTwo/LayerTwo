...
export class l2_local_status_view extends HTMLElement {
    constructor() {
        super();
    ...
    template() {
        ...
        <svg id="l2-local-status-rings" version="1.1" viewBox="0 0 1119.2297 523.22966" xmlns="http://www.w3.org/2000/svg">
...
customElements.define("l2-local-status-view", l2_local_status_view)