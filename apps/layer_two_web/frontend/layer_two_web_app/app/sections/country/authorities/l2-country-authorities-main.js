export class l2_country_authorities_main extends HTMLElement {
    constructor() {
        super();
...
customElements.define("l2-country-authorities-main", l2_country_authorities_main)