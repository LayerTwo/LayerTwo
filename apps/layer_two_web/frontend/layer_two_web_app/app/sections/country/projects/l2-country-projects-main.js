export class l2_country_projects_main extends HTMLElement {
    constructor() {
        super();
...
customElements.define("l2-country-projects-main", l2_country_projects_main)