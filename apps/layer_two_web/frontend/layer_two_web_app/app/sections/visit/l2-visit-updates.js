export class l2_visit_updates extends HTMLElement {
    ...
    render_template(){
        ...
        this.shadowRoot.querySelector("style").innerHTML = this.l2_visit_updates_style_show();        
    }

    hide_template(){
        this.shadowRoot.querySelector("style").innerHTML = this.l2_visit_updates_style_hide();
    }
    ...
    template() {
        ...
        <style>${this.l2_visit_updates_style_show()}</style>
        <h1>Visit Updates</h1>
        </template>
        `;
    }
