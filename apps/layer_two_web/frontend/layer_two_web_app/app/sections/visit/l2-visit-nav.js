...
export class l2_visit_nav extends HTMLElement {
    ...
    hide_template(){
        this.shadowRoot.querySelector("style").innerHTML = this.l2_visit_nav_style_hide();
    }

    show_template(){
        this.shadowRoot.querySelector("style").innerHTML = this.l2_visit_nav_style_show();
    }

    l2_visit_nav_style_hide(){
        return `
        :host {
            display: none;
    ...
    template() {
        return `
        <l2-sections-nav-button nav-section="l2-visit-nav" name="TBD"></l2-sections-nav-button>
        <l2-sections-nav-button nav-section="l2-visit-nav" name="TBD"></l2-sections-nav-button>
        <l2-sections-nav-button nav-section="l2-visit-nav" name="TBD"></l2-sections-nav-button>
        <l2-sections-nav-button nav-section="l2-visit-nav" name="TBD"></l2-sections-nav-button>
        <style>${this.l2_visit_nav_style_hide()}</style>`;
    }
