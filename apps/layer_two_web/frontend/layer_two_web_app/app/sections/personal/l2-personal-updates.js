export class l2_personal_updates extends HTMLElement {
    ...
    render_template(){
        ...
        this.shadowRoot.querySelector("style").innerHTML = this.l2_personal_updates_style_show();        
    }

    hide_template(){
        this.shadowRoot.querySelector("style").innerHTML = this.l2_personal_updates_style_hide();
    }
    ...
    l2_personal_updates_style_hide(){
        return `
        :host {
            display: none;
    ...
    l2_personal_updates_style_show(){
        return `
        :host {
            display: flex;
            flex-grow: 1;
    ...
    template() {
        ...
        <style>${this.l2_personal_updates_style_show()}</style>
