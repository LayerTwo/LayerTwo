export class l2_basic_world_stage extends HTMLElement {
    ...
    render_template(){
        let content = document.importNode(this.shadowRoot.querySelector("#l2-basic-world-stage-template").content, true);
        this.shadowRoot.appendChild(content);
        this.shadowRoot.querySelector("style").innerHTML = this.l2_basic_world_stage_style_show();        
    }
    hide_template(){
        this.shadowRoot.querySelector("style").innerHTML = this.l2_basic_world_stage_style_hide();
    }
    ...
    l2_basic_world_stage_style_hide(){
        return `
        :host {
            display: none;
            background: white;
    ...
    l2_basic_world_stage_default_style(){
        return `
        :host {
            display: none;
            background: white;
    ...
    template() {
        return `<template id="l2-basic-world-stage-template">
        <style>${this.l2_basic_world_stage_default_style()}</style>
