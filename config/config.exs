...
config :layertwo, LayertwoWeb.Endpoint,
  ...
  render_errors: [view: LayertwoWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Layertwo.PubSub,
  live_view: [signing_salt: "p7nsB6RK"]
...
config :layertwo, Layertwo.Mailer, adapter: Swoosh.Adapters.Local
