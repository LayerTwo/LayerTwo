...
import { l2_exit_confirm } from "./app/elements/l2-exit-confirm.js"
...
export class l2_main extends HTMLElement {
    ...
    l2_main_nav_state() {
        switch (sessionStorage.getItem("l2-main-nav")) {
            case "personal":
    ...
    show_main_stage_personal() {
        sessionStorage.setItem("l2-main-nav", "personal");
    ...
    show_main_stage_social() {
        sessionStorage.setItem("l2-main-nav", "social");
    ...
    show_main_stage_local() {
        sessionStorage.setItem("l2-main-nav", "local");
    ...
    show_main_stage_city() {
        sessionStorage.setItem("l2-main-nav", "city");
    ...
    show_main_stage_country() {
        sessionStorage.setItem("l2-main-nav", "country");
    ...
    show_main_stage_world() {
        sessionStorage.setItem("l2-main-nav", "world");
    ...
    show_main_stage_space() {
        sessionStorage.setItem("l2-main-nav", "space");
    ...
    show_main_stage_visit() {
        sessionStorage.setItem("l2-main-nav", "visit");
