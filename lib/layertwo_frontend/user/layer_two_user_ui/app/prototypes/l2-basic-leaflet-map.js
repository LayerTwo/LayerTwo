...
import {bing_map_key_import} from "./l2-bing-map-dev-key.js"

export class l2_basic_leaflet_map extends HTMLElement {
    constructor() {
        super();
        this.attachShadow({ mode: 'open' });
        this.bing_maps_key = bing_map_key_import;
    ...
    render_template(){
        let content = document.importNode(this.shadowRoot.querySelector("#l2-basic-leaflet-template").content, true);
        this.shadowRoot.appendChild(content);
        this.leaflet_map_init();
    }
    ...
    leaflet_map_init(){
        ...
        this.leaflet_map.setView([51.505, -0.09], 13);
    }
    ...
    template() {
        return `
        <template id="l2-basic-leaflet-template">
        <style>${this.basic_map_default_style()}</style>
        <div id="l2-basic-leaflet-map"></div>
        </template>
        `;
    }
