...
export class l2_stage_list_and_map extends HTMLElement {
    constructor() {
        super();
        document.addEventListener(`list-and-map-mbox`, this.handle_mbox_message.bind(this), true);
    ...
    html_constructor() {
        ...
        <div id='list-container' class="list-map-list-container">
        ${this.html_list_display()}
        </div>
        <div class="list-map-map-container">
        ${this.html_map()}
        </div>`;
    }
    ...
    html_list_display() {
        return `<l2-list-container section="${this.section}" sub-section="${this.sub_section}" view="${this.view_name}"></l2-l2-list-container>`;
    }
...
customElements.define("l2-stage-list-and-map", l2_stage_list_and_map)
