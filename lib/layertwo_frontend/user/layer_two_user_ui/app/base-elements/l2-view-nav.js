...
export class l2_view_nav extends HTMLElement {
    ...
    nav_selector() {
        switch (`${this.section}-${this.sub_section}`) {
            case "Local-Events":
                return `
                <l2-view-nav-button section="${this.section}-${this.sub_section}" name="List Events"></l2-view-nav-button>
                <l2-view-nav-button section="${this.section}-${this.sub_section}" display='false' name="Edit Event"></l2-view-nav-button>
                <l2-view-nav-button section="${this.section}-${this.sub_section}" name="Submit Event"></l2-view-nav-button>`;
                break;
            case "Local-Goals":
                return `
                <l2-view-nav-button section="${this.section}-${this.sub_section}" name="List Goals"></l2-view-nav-button>
                <l2-view-nav-button section="${this.section}-${this.sub_section}" display='false' name="Edit Goal"></l2-view-nav-button>
                <l2-view-nav-button section="${this.section}-${this.sub_section}" name="Submit Goal"></l2-view-nav-button>`;
                break;
            case "Local-Problems":
                return `
