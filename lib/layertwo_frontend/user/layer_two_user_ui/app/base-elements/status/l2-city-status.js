...
export class l2_city_status extends HTMLElement {
    constructor() {
        super();
        document.addEventListener('l2-city-status-mbox', this.handle_mbox_message.bind(this), true);
    }
    ...
    html_constructor() {
        return `
        <l2-leaflet-map section='City' sub-section='Status' view='City Status' class='l2-city-status-map'></l2-leaflet-map>
        <svg class="l2-city-status-rings" version="1.1" viewBox="0 0 1119.2297 523.22966" xmlns="http://www.w3.org/2000/svg">
...
customElements.define('l2-city-status', l2_city_status)
