export class l2_social_status extends HTMLElement {
    constructor() {
        super();
        document.addEventListener('l2-social-status-mbox', this.handle_mbox_message.bind(this), true);
    }
    ...
    html_constructor() {
        return `
        <svg class="social-svg" version="1.1" viewBox="0 0 1120.3 544.39" xmlns="http://www.w3.org/2000/svg">
...
customElements.define('l2-social-status', l2_social_status)
