export class l2_list_element extends HTMLElement {
    ...
    handle_update_element(event) {
        ...
        if(this.element_photo !== null && this.element_photo !== "none"){
            this.querySelector("#element-photo").setAttribute("src", "/uploads/"+this.element_photo);
        } else {
            this.querySelector("#element-photo").setAttribute("src", "");
        }
    ...
    html_element_photo() {
        return `<img id='element-photo' class='list-element-photo'/>`;
    }
