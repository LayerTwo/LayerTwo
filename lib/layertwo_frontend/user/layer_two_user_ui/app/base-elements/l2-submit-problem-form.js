...
export class l2_submit_problem_form extends HTMLElement {
    ...
    submit_success() {
        ...
        this.querySelector("#svg-photo-placeholder").setAttribute("display", "unset");
    ...
    photo_input_change(event) {
        let svg_image = this.querySelector("#photo-display");
        this.querySelector("#svg-photo-placeholder").setAttribute("display", "none");
    ...
    html_photo_input() {
        return `
        <input id="photo-input" class="submit-form-photo-input" type="file" accept="image/*" capture>
        `
    }
    ...
    html_gps_text_and_button() {
        return `
        <div id="gps-text" class='submit-form-gps-text'><input id="gps-button" class='submit-form-gps-button' type="button" value="Device GPS"> or select on the Map</div>
        `;
    }
