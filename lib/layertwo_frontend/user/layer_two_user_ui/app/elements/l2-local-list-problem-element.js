export class l2_local_list_problem_element extends HTMLElement {
    ...
    handle_delete_button_clicked() {
        if (this.deletion_warning_element === undefined) {
            this.dispatchEvent(new CustomEvent("l2-city-local-problems-disable-marker", { detail: { local_problem_uuid: this.local_problem_uuid }, bubble: true, composed: true }));
    ...
    handle_delete_cancel_button_clicked() {
        this.dispatchEvent(new CustomEvent("l2-city-local-problems-enable-marker", { detail: { local_problem_uuid: this.local_problem_uuid }, bubble: true, composed: true }));
