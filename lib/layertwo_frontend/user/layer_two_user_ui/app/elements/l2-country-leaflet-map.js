...
export class l2_country_leaflet_map extends l2_basic_leaflet_map {
    ...
    set_leaflet_map_view(){
        ...
        this.leaflet_map.setView([sessionStorage.getItem("country_latitude"), sessionStorage.getItem("country_longitude")], parseInt(sessionStorage.getItem("country_default_zoom")));
        }
    }
