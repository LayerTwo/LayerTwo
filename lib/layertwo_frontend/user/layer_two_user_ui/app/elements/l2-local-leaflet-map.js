...
export class l2_local_leaflet_map extends l2_basic_leaflet_map {
    ...
    set_leaflet_map_view(){
        ...
        this.leaflet_map.setView([parseFloat(sessionStorage.getItem("entity_latitude")), parseFloat(sessionStorage.getItem("entity_longitude"))], parseInt(sessionStorage.getItem("city_local_default_zoom")));
        }
    }
