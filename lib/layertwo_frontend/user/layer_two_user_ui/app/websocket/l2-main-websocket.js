...
export class l2_main_websocket extends l2_channel_visit {
    ...
    join_channel_personal(){
        ...
        this.channel_personal.join().receive("ok", resp => {this.channel_personal_init_process(), console.log("Joined l2_personal successfully!")});
    }

    join_channel_social(){
        this.channel_social_name = `l2_social:${this.entity_ws_uuid}`;
        this.channel_social = this.socket.channel(this.channel_social_name,{});
        this.channel_social.join().receive("ok", resp => {this.channel_social_init_process(), console.log("Joined l2_social successfully!")});
    }
    ...
    join_channel_city_local(){
        ...
        this.channel_city_local.join().receive("ok", resp => {this.channel_city_local_init_process(), console.log("Joined l2_city_local successfully!")});
    ...
    join_channel_city(){
        ...
        this.channel_city.join().receive("ok", resp => {this.channel_city_init_process(), console.log("Joined l2_city successfully!")});
    }
    ...
    join_channel_country(){
        ...
        this.channel_country.join().receive("ok", resp => {this.channel_country_init_process(), console.log("Joined l2_country successfully!")});
    }

    join_channel_world(){
        this.channel_world_name = `l2_world:${this.entity_ws_uuid}`;
        this.channel_world = this.socket.channel(this.channel_world_name,{});
        this.channel_world.join().receive("ok", resp => {this.channel_world_init_process(), console.log("Joined l2_world successfully!")});
    }

    join_channel_space(){
        this.channel_space_name = `l2_space:${this.entity_ws_uuid}`;
        this.channel_space = this.socket.channel(this.channel_space_name,{});
        this.channel_space.join().receive("ok", resp => {this.channel_space_init_process(), console.log("Joined l2_space successfully!")});
    }

    join_channel_visit(){
        this.channel_visit_name = `l2_visit:${this.entity_ws_uuid}`;
        this.channel_visit = this.socket.channel(this.channel_visit_name,{});
        this.channel_visit.join().receive("ok", resp => {this.channel_visit_init_process(), console.log("Joined l2_visit successfully!")});
    }
