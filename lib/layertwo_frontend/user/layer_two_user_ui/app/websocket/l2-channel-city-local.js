...
export class l2_channel_city_local extends l2_channel_social {
    constructor() {
        ...
        document.addEventListener("l2-city-local-problem-update-form-data-submit", this.send_city_local_problem_update_form_data.bind(this), true);
    ...
    send_city_local_problem_form_data(data) {
        this.channel_city_local.push("l2-city-local-problem-form-data-submit", {
            problem_title: data.detail.problem_title,
            ...
            problem_longitude: data.detail.problem_longitude
        }, 10000);
    }

    send_city_local_problem_update_form_data(data) {
        this.channel_city_local.push("l2-city-local-problem-update-form-data-submit", {
            problem_uuid: data.detail.problem_uuid,
            problem_title: data.detail.problem_title,
            problem_importance: data.detail.problem_importance,
            problem_description: data.detail.problem_description,
            problem_latitude: data.detail.problem_latitude,
    ...
    channel_city_local_on() {
        ...
        this.channel_city_local.on("l2-city-local-problem-edit-success", data => this.channel_city_local_handle_local_problem_edit_success());
        this.channel_city_local.on("l2-city-local-problem-edit-failed", data => this.channel_city_local_handle_local_problem_edit_failed());
        this.channel_city_local.on("l2-city-local-update-local-problem", data => this.channel_city_local_handle_update_local_problem(data));
    }

    channel_city_local_handle_update_local_problem(data){
        this.dispatchEvent(new CustomEvent("l2-city-local-update-local-problem", { detail:{update: data},bubble: true, composed: true }));
    }
    ...
    channel_city_local_handle_local_problem_edit_success() {
        this.dispatchEvent(new CustomEvent("l2-city-local-problem-update-success", { bubble: true, composed: true }));
    }

    channel_city_local_handle_local_problem_edit_failed() {
        this.dispatchEvent(new CustomEvent("l2-city-local-problem-update-failed", { bubble: true, composed: true }));
    }
