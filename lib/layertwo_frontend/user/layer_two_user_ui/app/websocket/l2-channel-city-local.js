...
export class l2_channel_city_local extends l2_channel_social {
    ...
    channel_city_local_handle_local_problem_description(data) {
        this.dispatchEvent(new CustomEvent("list-element-mbox", { detail: { element_uuid: data.local_problem_uuid, element_description: data.local_problem_description, action: 'update-description' }, bubble: true, composed: true }));
    }
