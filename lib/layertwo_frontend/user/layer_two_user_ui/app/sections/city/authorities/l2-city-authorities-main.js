export class l2_city_authorities_main extends HTMLElement {
    constructor() {
        super();
...
customElements.define("l2-city-authorities-main", l2_city_authorities_main)