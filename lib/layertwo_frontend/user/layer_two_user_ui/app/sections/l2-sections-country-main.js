...
export class l2_sections_country_main extends HTMLElement {
    ...
    l2_country_nav_state() {
        switch (sessionStorage.getItem("l2-country-nav")) {
            case "authorities":
    ...
    show_country_view_authorities() {
        sessionStorage.setItem("l2-country-nav", "authorities");
    ...
    show_country_view_economy() {
        sessionStorage.setItem("l2-country-nav", "economy");
    ...
    show_country_view_events() {
        sessionStorage.setItem("l2-country-nav", "events");
    ...
    show_country_view_goals() {
        sessionStorage.setItem("l2-country-nav", "goals");
    ...
    show_country_view_problems() {
        sessionStorage.setItem("l2-country-nav", "problems");
    ...
    show_country_view_projects() {
        sessionStorage.setItem("l2-country-nav", "projects");
    ...
    show_country_view_status() {
        sessionStorage.setItem("l2-country-nav", "status");
