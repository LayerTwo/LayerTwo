export class l2_personal_education_main extends HTMLElement {
    constructor() {
        super();
...
customElements.define("l2-personal-education-main", l2_personal_education_main)