import {l2_basic_personal_stage} from "../../../prototypes/l2-basic-personal-stage.js"

export class l2_personal_status_main extends HTMLElement {
    constructor() {
        super();
    ...
    template() {
        ...
        <l2-basic-personal-stage></l2-basic-personal-stage>
        </template>
        `;
    }
...
customElements.define("l2-personal-status-main", l2_personal_status_main)