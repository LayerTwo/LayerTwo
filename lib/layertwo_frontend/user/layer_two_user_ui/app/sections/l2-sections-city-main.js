...
export class l2_sections_city_main extends HTMLElement {
    ...
    l2_city_nav_state() {
        switch (sessionStorage.getItem("l2-city-nav")) {
            case "authorities":
    ...
    show_city_view_authorities() {
        sessionStorage.setItem("l2-city-nav", "authorities");
    ...
    show_city_view_businesses() {
        sessionStorage.setItem("l2-city-nav", "businesses");
    ...
    show_city_view_events() {
        sessionStorage.setItem("l2-city-nav", "events");
    ...
    show_city_view_goals() {
        sessionStorage.setItem("l2-city-nav", "goals");
    ...
    show_city_view_leisure() {
        sessionStorage.setItem("l2-city-nav", "leisure");
    ...
    show_city_view_problems() {
        sessionStorage.setItem("l2-city-nav", "problems");
    ...
    show_city_view_projects() {
        sessionStorage.setItem("l2-city-nav", "projects");
    ...
    show_city_view_status() {
        sessionStorage.setItem("l2-city-nav", "status");
