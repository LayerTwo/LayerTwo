...
import { l2_local_edit_problem } from "./edit_problem/l2-local-edit-problem.js"
...
export class l2_local_problems_stage extends HTMLElement {
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        ...
        if (name === 'display-view' && newValue === 'edit-problem') {
            this.shadowRoot.querySelector('l2-local-edit-problem').setAttribute('render-template', 'true');
            this.shadowRoot.querySelector('l2-local-edit-problem').setAttribute('show-template', 'true');
        } else {
            this.shadowRoot.querySelector('l2-local-edit-problem').setAttribute('show-template', 'false');
        }
    }
    ...
    template() {
        ...
        <l2-local-edit-problem></l2-local-edit-problem>
